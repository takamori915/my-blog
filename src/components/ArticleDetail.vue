  ...
  <section class="article-detail">
    ...
    <v-container>
      <v-row class="article-detail__contents">
        ...
        <v-col cols="12" md="6" class="article-detail__contents-img">
          <v-carousel hide-delimiters height="450px">
            <v-carousel-item>
              <img :src="article.imgUrl1" alt="" class="img-fluid">
            </v-carousel-item>
            <v-carousel-item>
              <img :src="article.imgUrl2" alt="" class="img-fluid">
            </v-carousel-item>
            <v-carousel-item>
              <img :src="article.imgUrl3" alt="" class="img-fluid">
            </v-carousel-item>
          </v-carousel>
        </v-col>
        <v-col cols="12" md="6" class="article-detail__contents-img">
