...
export default {
  ...
  async mounted() {
    ...
    const response = await axios.get(
      "https://takamori-c.microcms.io/api/v1/articles?filters=category[contains]旅行[or]category[contains]商品[or]category[contains]温泉[or]category[contains]食事[or]category[contains]ラーメン[or]category[contains]キッズ[or]category[contains]スポット[or]category[contains]曲♪",
      {
